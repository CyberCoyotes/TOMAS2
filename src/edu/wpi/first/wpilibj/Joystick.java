...
public class Joystick extends GenericHID {
  ...
  public boolean isReading(Joystick joystick) {
	  if(joystick.getRawButton(1) || joystick.getRawButton(2) || joystick.getRawButton(3) || joystick.getRawButton(4) || joystick.getRawButton(5) || joystick.getRawButton(6) || joystick.getRawButton(7) || joystick.getRawButton(8) || joystick.getRawButton(9) || joystick.getRawButton(10) ||  joystick.getRawButton(1) || joystick.getRawButton(2) || joystick.getRawButton(3) || joystick.getRawButton(4) || joystick.getRawButton(5) || joystick.getRawButton(6) || joystick.getRawButton(7) || joystick.getRawButton(8) || joystick.getRawButton(9) || joystick.getRawButton(10) || joystick.getRawAxis(0) >= 0.05 || joystick.getRawAxis(1) >= 0.05 || joystick.getRawAxis(2) >= 0.05 || joystick.getRawAxis(3) >= 0.05 || joystick.getRawAxis(4) >= 0.05 || joystick.getRawAxis(5) >= 0.05 || joystick.getRawAxis(6) >= 0.05 || joystick.getRawAxis(0) >= 0.05 || joystick.getRawAxis(1) >= 0.05 || joystick.getRawAxis(2) >= 0.05 || joystick.getRawAxis(3) >= 0.05 || joystick.getRawAxis(4) >= 0.05 || joystick.getRawAxis(5) >= 0.05 || joystick.getRawAxis(6) >= 0.05 || joystick.getRawAxis(0) <= -0.05 || joystick.getRawAxis(1) <= -0.05 || joystick.getRawAxis(2) <= -0.05 || joystick.getRawAxis(3) <= -0.05 || joystick.getRawAxis(4) <= -0.05 || joystick.getRawAxis(5) <= -0.05 || joystick.getRawAxis(6) <= -0.05 || joystick.getRawAxis(0) <= -0.05 || joystick.getRawAxis(1) <= -0.05 || joystick.getRawAxis(2) <= -0.05 || joystick.getRawAxis(3) <= -0.05 || joystick.getRawAxis(4) <= -0.05 || joystick.getRawAxis(5) <= -0.05 || joystick.getRawAxis(6) <= -0.05) {
		  return true;
	  } else {
		  return false;
	  }
